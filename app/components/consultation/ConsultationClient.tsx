...
const NEXT_STEPS = [
  {
    ...
    desc: "Usually within one business day, to understand your requirement in more detail.",
  },
  {
    title: "Quick eligibility read",
    desc: "A candid view of what you're likely to qualify for, based on what you share with us.",
  },
  {
    title: "Lender / insurer shortlist",
    desc: "We narrow down to 2–3 options that genuinely fit your profile, and explain the trade-offs.",
  },
  {
    title: "You decide, we execute",
    desc: "Once you choose a direction, we handle documentation and coordination through to completion.",
  },
];
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative bg-surface px-6 py-16">
        <div className="mx-auto max-w-7xl">
          <SectionHeading eyebrow="What happens next" title="From your first message to a plan" align="center" />
      ...
      <section className="relative bg-white px-6 py-16">
        <div className="mx-auto max-w-3xl">
          <SectionHeading eyebrow="Before you reach out" title="Common questions" align="center" />
          <FAQAccordion items={FAQ_CATEGORIES.find((c) => c.category === "Working with us")?.items ?? []} />
        </div>
      </section>
    </div>
  );
